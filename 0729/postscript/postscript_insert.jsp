...
<body style="text-align:center;">
	<h3 style="color:#6b639f; margin-top:50px; font-size:25px; font-weight:bold;">후기 등록</h3>
...
%>
	...
	<form name="write_form" method="post" enctype="multipart/form-data"> <!-- submit위해 form 설정 -->
		...
		<!-- write_data.jsp에 필요한 데이터지만 보여줄 필요는 없으므로 hidden으로 감추었다 -->
		<input type="hidden" id="rootid" name="rootid" value="0">
		<input type="hidden" id="relevel" name="relevel" value="0">
		<input type="hidden" id="recnt" name="recnt" value="0">
