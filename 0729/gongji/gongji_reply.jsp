...
<%
	...
	try{
		// gongji_view.jsp 에서 get으로 id 값 받아온다
		...
		PreparedStatement pset = conn.prepareStatement("select * from gongji where id = ?");
		...
		PreparedStatement pset2 = conn.prepareStatement("select * from gongji where rootid = ? order by recnt asc");
